...
public class MainActivity extends AppCompatActivity {
    ...
    private void addValue(String value){
        ...
        int carsorposition= text.getSelectionStart();
        String left=val.substring(0,carsorposition);
        String right=val.substring(carsorposition);
        if(getString(R.string.textfield).equals(text.getText().toString())){
           text.setText("");
            text.setText(value);
            text.setSelection(carsorposition + 1);
        }else {
